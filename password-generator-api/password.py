...
class PasswordGenerator:
    ...
    Args:
        ...
        passwords_num: (int) number of passwords that must be created.
    """
    def __init__(self, min_length = 6, schars_num = 1, numbers_num = 1, passwords_num = 1):
        self.min_length = min_length
        self.schars_num = schars_num
        self.numbers_num = numbers_num
        self.passwords_num = passwords_num
    ...
    def generate_passwords_list(self):
        ...
        passwords_list = []
        for i in range(1, self.passwords_num+1):
